...
void Board::OnTimer(wxCommandEvent& event)
{
    if (isFallingFinished) {
        isFallingFinished = false;//@hlh:我感觉这个值是不是可以不用？
    }
    clean_complete();
    Refresh();
